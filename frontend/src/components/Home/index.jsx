        ...
        <div className="footer-inner">
          <div className="footer-brand">
            ...
            <div className="footer-socials">
              <a href="https://x.com/MutyalaUpendhra" target="_blank" aria-label="Twitter">𝕏</a>
              <a href="https://www.linkedin.com/in/upendhra-mutyala-04390623b/" target="_blank" aria-label="LinkedIn">in</a>
              <a href="https://github.com/Upendhra777" target="_blank" aria-label="GitHub">⌥</a>
            </div>
          </div>
